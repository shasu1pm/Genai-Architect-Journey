...
1. Open <https://code.visualstudio.com/download> and select **Windows**.
...
1. Open <https://code.visualstudio.com/download> and select **Mac**.
...
1. Open <https://www.python.org/downloads/> and download the Windows installer.
2. Run the installer.
...
1. Open <https://www.python.org/downloads/> and download the macOS installer.
...
1. Open <https://git-scm.com/downloads> and select **Windows**. The download begins automatically.
2. Run the installer.
...
**Option A — official installer:** download from <https://git-scm.com/downloads> and run the `.pkg`.
...
**Web** — no installation required. Open <https://claude.ai>, sign in with an email address or Google account, and begin.

**Windows**

1. Open <https://claude.ai/download> and select the Windows installer.
2. Run the downloaded installer.
3. Launch the application and sign in.

**macOS**

1. Open <https://claude.ai/download> and select the macOS build.
...
1. Open <https://windsurf.com/download> and select **Windows**.
2. Run the installer.
...
1. Open <https://windsurf.com/download> and select **Mac**.
...
1. Open <https://ollama.com/download> and select **Windows**.
...
1. Open <https://ollama.com/download> and select **macOS**.
...
1. Ensure you have a Google account. If not, create one at <https://accounts.google.com/signup>.
...
| :-- | :-- |
| **Purpose** | A lightweight, extensible code editor used as the main workspace for writing, running, and version-controlling your projects. |
| **Official website** | <a href="https://code.visualstudio.com" target="_blank" rel="noopener">https://code.visualstudio.com</a> |
| **Download** | <a href="https://code.visualstudio.com/download" target="_blank" rel="noopener">https://code.visualstudio.com/download</a> |

### Windows installation

1. Open <a href="https://code.visualstudio.com/download" target="_blank" rel="noopener">https://code.visualstudio.com/download</a> and select **Windows**.
2. Run the downloaded `VSCodeUserSetup-x64-<version>.exe`.
3. Accept the licence agreement and continue.
4. On the **Select Additional Tasks** screen, enable:
   - `Add "Open with Code" action to Windows Explorer file context menu`
...
1. Open <a href="https://code.visualstudio.com/download" target="_blank" rel="noopener">https://code.visualstudio.com/download</a> and select **Mac**.
2. Open the downloaded `.zip` to extract `Visual Studio Code.app`.
3. Drag the application into the **Applications** folder.
4. Launch it from Applications. If macOS warns about an unidentified developer, open **System Settings → Privacy & Security** and select **Open Anyway**.
5. Press <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>P</kbd>, run **Shell Command: Install 'code' command in PATH**.
...
| :-- | :-- |
| **Purpose** | The programming language used across the AI ecosystem and throughout this repository. |
| **Official website** | <a href="https://www.python.org" target="_blank" rel="noopener">https://www.python.org</a> |
| **Download** | <a href="https://www.python.org/downloads/" target="_blank" rel="noopener">https://www.python.org/downloads/</a> |
...
1. Open <a href="https://www.python.org/downloads/" target="_blank" rel="noopener">https://www.python.org/downloads/</a> and download the Windows installer.
2. Run the installer.
3. **On the first screen, tick `Add python.exe to PATH`.** This is the single most commonly missed step.
4. Select **Install Now**.
5. If offered, select **Disable path length limit** at the end.
...
1. Open <a href="https://www.python.org/downloads/" target="_blank" rel="noopener">https://www.python.org/downloads/</a> and download the macOS installer.
2. Open the `.pkg` file and follow the prompts.
...
| :-- | :-- |
| **Purpose** | Distributed version control. Git tracks every change, allows safe experimentation, and is the mechanism by which your work reaches GitHub. |
| **Official website** | <a href="https://git-scm.com" target="_blank" rel="noopener">https://git-scm.com</a> |
| **Download** | <a href="https://git-scm.com/downloads" target="_blank" rel="noopener">https://git-scm.com/downloads</a> |

### Windows installation

1. Open <a href="https://git-scm.com/downloads" target="_blank" rel="noopener">https://git-scm.com/downloads</a> and select **Windows**. The download begins automatically.
2. Run the installer.
3. Accept the defaults except where noted:
   - **Default editor** — select *Use Visual Studio Code as Git's default editor*.
   - **Initial branch name** — select *Override the default branch name* and enter `main`.
...
**Option A — official installer:** download from <a href="https://git-scm.com/downloads" target="_blank" rel="noopener">https://git-scm.com/downloads</a> and run the `.pkg`.
...
| :-- | :-- |
| **Purpose** | Hosts your repositories remotely, backs up your work, and serves as the public portfolio that demonstrates your capability. |
| **Official website** | <a href="https://github.com" target="_blank" rel="noopener">https://github.com</a> |
| **Sign up** | <a href="https://github.com/signup" target="_blank" rel="noopener">https://github.com/signup</a> |

### Create an account

1. Open <a href="https://github.com/signup" target="_blank" rel="noopener">https://github.com/signup</a>.
2. Enter your email address.
3. Create a strong password.
4. Choose a username — see the guidance below; this appears in every project URL.
5. Verify your email address.
...
| :-- | :-- |
| **Purpose** | The central hub of the open AI ecosystem — hundreds of thousands of models, datasets, and interactive demos, plus the libraries used to run them. |
| **Official website** | <a href="https://huggingface.co" target="_blank" rel="noopener">https://huggingface.co</a> |
| **Sign up** | <a href="https://huggingface.co/join" target="_blank" rel="noopener">https://huggingface.co/join</a> |

### Create an account

1. Open <a href="https://huggingface.co/join" target="_blank" rel="noopener">https://huggingface.co/join</a>.
2. Enter your email address and create a password.
3. Choose a username.
4. Verify your email address.
5. Complete the onboarding questions.
...
| :-- | :-- |
| **Purpose** | An AI assistant built for extended reasoning, long-document analysis, structured writing, and software development. Useful as a working partner while learning — for explaining concepts, reviewing code, and drafting documentation. |
| **Official website** | <a href="https://claude.ai" target="_blank" rel="noopener">https://claude.ai</a> |
| **Desktop app** | <a href="https://claude.ai/download" target="_blank" rel="noopener">https://claude.ai/download</a> |

### Installation

**Web** — no installation required. Open <a href="https://claude.ai" target="_blank" rel="noopener">https://claude.ai</a>, sign in with an email address or Google account, and begin.

**Windows**

1. Open <a href="https://claude.ai/download" target="_blank" rel="noopener">https://claude.ai/download</a> and select the Windows installer.
2. Run the downloaded installer.
3. Launch the application and sign in.

**macOS**

1. Open <a href="https://claude.ai/download" target="_blank" rel="noopener">https://claude.ai/download</a> and select the macOS build.
2. Open the `.dmg` and drag **Claude** into **Applications**.
3. Launch it from Applications and sign in.
...
| :-- | :-- |
| **Purpose** | An AI-native code editor. It reads your entire project as context, which allows it to make coordinated changes across multiple files rather than suggesting isolated snippets. |
| **Official website** | <a href="https://windsurf.com" target="_blank" rel="noopener">https://windsurf.com</a> |
| **Download** | <a href="https://windsurf.com/download" target="_blank" rel="noopener">https://windsurf.com/download</a> |

### Installation

**Windows**

1. Open <a href="https://windsurf.com/download" target="_blank" rel="noopener">https://windsurf.com/download</a> and select **Windows**.
2. Run the installer.
3. On first launch, choose to import your VS Code settings, keybindings, and extensions.
4. Sign in to activate AI features.
...
1. Open <a href="https://windsurf.com/download" target="_blank" rel="noopener">https://windsurf.com/download</a> and select **Mac**.
2. Open the `.dmg` and drag **Windsurf** into **Applications**.
3. Launch it, import your VS Code settings if prompted, and sign in.
...
| :-- | :-- |
| **Purpose** | Run large language models entirely on your own machine. Nothing is sent to an external service, which makes it the natural choice for private data, offline work, and unrestricted experimentation. |
| **Official website** | <a href="https://ollama.com" target="_blank" rel="noopener">https://ollama.com</a> |
| **Download** | <a href="https://ollama.com/download" target="_blank" rel="noopener">https://ollama.com/download</a> |
...
1. Open <a href="https://ollama.com/download" target="_blank" rel="noopener">https://ollama.com/download</a> and select **Windows**.
2. Run `OllamaSetup.exe`.
3. Follow the prompts. Ollama installs as a background service and starts automatically.
4. Open a new terminal window.
...
1. Open <a href="https://ollama.com/download" target="_blank" rel="noopener">https://ollama.com/download</a> and select **macOS**.
2. Open the downloaded `.zip` and drag **Ollama** into **Applications**.
3. Launch it. The menu-bar icon confirms the service is running.
...
| :-- | :-- |
| **Purpose** | A browser-based Jupyter notebook environment hosted by Google. It requires no local installation and provides access to hardware accelerators, which makes it ideal for experimentation on any machine. |
| **Official website** | <a href="https://colab.research.google.com" target="_blank" rel="noopener">https://colab.research.google.com</a> |
| **Google account** | <a href="https://accounts.google.com/signup" target="_blank" rel="noopener">https://accounts.google.com/signup</a> |
...
1. Ensure you have a Google account. If not, create one at <a href="https://accounts.google.com/signup" target="_blank" rel="noopener">https://accounts.google.com/signup</a>.
2. Open <a href="https://colab.research.google.com" target="_blank" rel="noopener">https://colab.research.google.com</a>.
3. Sign in with your Google account. No further setup is required.
